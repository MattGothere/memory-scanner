...
Every milestone in this repository starts with a question. For each question I try to:
...
I don't expect to know the answers yet. This repository exists to find them.
